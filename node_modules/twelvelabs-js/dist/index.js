...
class TwelveLabs extends core_1.APIClient {
    ...
    async analyze(videoId, prompt, temperature, options = {}) {
        ...
        const res = await this._post('analyze', (0, util_1.removeUndefinedValues)(_body), options);
        return res;
    }
...
Object.defineProperty(exports, "GenerateTextStreamResult", { enumerable: true, get: function () { return models_1.GenerateTextStreamResult; } });
