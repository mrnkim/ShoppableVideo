...
export class Task extends APIResource {
    ...
    async createBulk(indexId, { files, urls, enableVideoStream, }, options = {}) {
        if (!files && !urls) {
