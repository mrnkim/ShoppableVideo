...
export class EmbedTask extends APIResource {
    async retrieve(id, params = {}, options = {}) {
        ...
        const res = await this._get(path, queryParams, options);
